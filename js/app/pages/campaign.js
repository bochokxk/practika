          ...
          <div class="flex body">
            <div class="w30 ar filchart">
              ...
              <div class="itemchart ptb10" v-if="parent.formData.sites" v-for="s in parent.formData.sites">
                <toogle v-model="s.include" @update:modelValue="s.include = $event;getCampaignBannersChart();" />
                {{s.site}}
              </div>
            </div>
            ...
            <tbody>
              <tr v-for="(item,i) in data.items">
                <td class="actions">
                  ...
                  <a href="#" @click.prevent="parent.formData = JSON.parse(JSON.stringify(item));iChart = i;$refs.chart.active=1;getCampaignBannersChart()">
                ...
                <td class="id">
                  <toogle :modelValue="item.published" @update:modelValue="item.published = $event;parent.formData = item;actionAd();"></toogle>
                </td>
